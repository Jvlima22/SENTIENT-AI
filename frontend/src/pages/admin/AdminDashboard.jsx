...
export default function AdminDashboard() {
  ...
  if (!m) return <div className="flex justify-center py-20"><Loader2 className="w-8 h-8 text-[#FF7A59] animate-spin" /></div>;
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-xl bg-[#0F0F13] border border-white/10 p-5">
          <h3 className="font-display text-base mb-4 flex items-center gap-2"><TrendingUp className="w-4 h-4 text-[#FF7A59]" /> Mais vistos</h3>
        ...
        <div className="rounded-xl bg-[#0F0F13] border border-white/10 p-5">
          <h3 className="font-display text-base mb-4 flex items-center gap-2"><Users className="w-4 h-4 text-[#FF7A59]" /> Leads recentes</h3>
          <div className="space-y-3">
