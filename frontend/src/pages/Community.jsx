  ...
  return (
    <div className="max-w-[1400px] mx-auto px-5 md:px-8 py-12">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs uppercase tracking-wide text-[#00F0FF] font-mono-code">Conecte-se</span>
      </div>
          ...
          {links.map((l, i) => {
            ...
            return (
              <a key={l.id} href={l.url} target="_blank" rel="noreferrer" data-testid={`community-${l.platform}`}
                className="grid-fade-in group rounded-xl bg-[#0F0F13] border border-white/10 p-6 hover:border-[#00F0FF]/30 hover:-translate-y-1 transition-transform transition-colors"
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <ArrowUpRight className="w-5 h-5 text-white/30 group-hover:text-[#00F0FF] transition-colors" />
                </div>
